...
class Envs:
    ...
    # Debug only: copy each MoE group_list to CPU and print it on TP rank 0.
    # This introduces a device synchronization and must stay disabled in
    # performance runs.
    SGLANG_NPU_PRINT_MOE_GROUP_LIST = EnvBool(False)
