...
class Scheduler(
    ...
    def maybe_init_ngram_embedding(self):
        ...
        if self.use_ngram_embedding:
            ...
            self.ngram_embedding_n = self.tp_worker.model_config.ngram_embedding_n
            self.ngram_embedding_k = self.tp_worker.model_config.ngram_embedding_k
    ...
    def event_loop_overlap(self):
        ...
        # Minimum batch size used to collect a stable profiling pipeline.
        prof_bs: int = int(os.getenv("PROFILING_BS", 8))
        # Decode or prefill pipeline.
        ...
        if enable_profiling:
            print("profiling enable!===================", flush=True)
            prof_cnt = 0
            import torch_npu
            ...
            prof = torch_npu.profiler.profile(
                ...
                schedule=torch_npu.profiler.schedule(
                    wait=1, warmup=1, active=prof_step, repeat=1, skip_first=1
                ),
                record_shapes=True,
                profile_memory=True,
                with_stack=False,  # Disable call-stack collection.
                with_flops=False,
                with_modules=False,
    ...
    def _get_new_batch_prefill_raw(
        ...
        adder = PrefillAdder(
            ...
            mixed_decode_kv_tokens=mixed_decode_kv_tokens,
        )
