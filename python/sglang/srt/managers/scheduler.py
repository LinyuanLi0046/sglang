...
class Scheduler(
    ...
    def event_loop_overlap(self):
        ...
        # 采集profiling时最小的batchsize数量 用来采集稳定状态的流水
        ...
        if enable_profiling:
            ...
            prof = torch_npu.profiler.profile(
                ...
                schedule=torch_npu.profiler.schedule(wait=1, warmup=1, active=prof_step, repeat=1, skip_first=1),
                record_shapes=True,
                profile_memory=True,
                with_stack=False, # 带调用栈采集
                with_flops=False,
                with_modules=False,
